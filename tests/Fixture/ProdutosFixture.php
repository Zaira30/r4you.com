...
class ProdutosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nome' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'preco' => 1,
            'created' => '2017-07-19 22:02:08',
            'modifield' => '2017-07-19 22:02:08'
        ],
    ];
}
